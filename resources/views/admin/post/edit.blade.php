...
@section('content')
    <div class="content-wrapper p-2">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Post - edit
                    ...
                    <div class="card-body">
                        ...
                        <label for="basic-url">Thumbnail</label>
                            <div class="input-group mb-3 @if($errors->has('thumbnail')) has-error @endif">
                              ...
                              {!! Form::text('thumbnail', $post->thumbnail, ['class' => 'form-control', 'placeholder' => 'Name', 'id'=>'thumbnail']) !!}
                        ...
                        <div class="form-group @if($errors->has('short_desc')) has-error @endif">
                            ...
                            {!! Form::textarea('short_desc', $post->short_desc, ['class' => 'textarea form-control', 'placeholder' => 'Short Description', 'rows'=>3]) !!}
                        ...
                        <div class="form-group @if($errors->has('details')) has-error @endif">
                            {!! Form::label('Details') !!}
                            {!! Form::textarea('details', $post->details, ['class' => 'form-control textarea', 'placeholder' => 'Details']) !!}
