...
@section('content')
    <div class="content-wrapper p-2">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Event - Edit
                        <a href="{{ route('events.index') }}" class="btn btn-sm btn-primary float-right">Back to List</a>
                    </div>

                    <div class="card-body">
                        
                    {!! Form::open(['route' =>  ['events.update', $events->id], 'enctype' => 'multipart/form-data', 'method' => 'put']) !!}
                        ...
                        <label for="basic-url">Thumbnail</label>
                            <div class="input-group mb-3 @if($errors->has('thumbnail')) has-error @endif">
                              ...
                              {!! Form::text('thumbnail', $events->thumbnail, ['class' => 'form-control', 'placeholder' => 'Url', 'id'=>'thumbnail']) !!}
                            </div>
                        ...
                        <div class="form-group @if($errors->has('details')) has-error @endif">
                            {!! Form::label('Details') !!}
                            {!! Form::textarea('details', $events->details, ['class' => 'textarea form-control', 'placeholder' => 'Details']) !!}
                            ...
                            <div class='col-md-5'>
                                <div class="form-group @if($errors->has('start_date')) has-error @endif">
                                   ...
                                   <div class="input-group date" id="datetimepicker7" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker7" name="start_date" value="{{ $events->start_date }}" />
                            ...
                            <div class='col-md-5'>
                                <div class="form-group @if($errors->has('end_date')) has-error @endif">
                                   ...
                                   <div class="input-group date" id="datetimepicker8" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker8" name="end_date" value="{{ $events->end_date }}" />
                        ...
                        <div class="form-group @if($errors->has('venue')) has-error @endif">
                            {!! Form::label('Venue') !!}
                            {!! Form::text('venue', $events->venue, ['class' => 'form-control', 'placeholder' => 'Title']) !!}
                            @if ($errors->has('venue'))
