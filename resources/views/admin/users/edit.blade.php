        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' =>  ['users.update', $users->id], 'enctype' => 'multipart/form-data', 'method' => 'put']) !!}
                        ...
                        <label for="basic-url">Avator</label>
                            <div class="input-group mb-3 @if($errors->has('avator')) has-error @endif">
                              ...
                              {!! Form::text('avator', $users->avator, ['class' => 'form-control', 'placeholder' => 'Avator', 'id'=>'thumbnail']) !!}
                              @if ($errors->has('avator'))<span
                                class="text-danger">{!! $errors->first('avator') !!}</span>@endif
                            </div>
                        <div class="form-group">
                            {!! Form::label('User Role') !!}
                            {!! Form::select('role', ['admin' => 'Administrator', 'author' => 'Author', 'editor' => 'Editor'], $users->role, ['class' => 'form-control']) !!}
                        </div>
