...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <iframe src="http://localhost/cms/public/admin/files" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
      </div>
    </div>
  </div>
  ...
  <script>
   var route_prefix = "/cms/public/admin/files";
  </script>
